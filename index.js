...
const UUID = process.env.UUID || '93704f7c-ecfc-473d-b6de-c632f148a7bf'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'zxnm.waliu.dpdns.org';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
const AUTO_ACCESS = process.env.AUTO_ACCESS || true;      // 是否开启自动访问保活,false为关闭,true为开启,需同时填写DOMAIN变量
const SUB_PATH = process.env.SUB_PATH || 'sub';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'IN-印度2';                    // 节点名称
const PORT = process.env.PORT ||7356;                     // http和ws服务端口
