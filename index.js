...
const UUID = process.env.UUID || 'bb01c01c-0e15-4426-a91c-61966628337a'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'uadplxrk.waliu.dpdns.org';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
const AUTO_ACCESS = process.env.AUTO_ACCESS || true;      // 是否开启自动访问保活,false为关闭,true为开启,需同时填写DOMAIN变量
const SUB_PATH = process.env.SUB_PATH || 'sub';            // 获取节点的订阅路径
const NAME = process.env.NAME || '德国1';                    // 节点名称
const PORT = process.env.PORT || 6854;                     // http和ws服务端口
